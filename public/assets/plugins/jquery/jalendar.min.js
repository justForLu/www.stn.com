! function(a) {
	a.fn.jalendar = function(t) {
		function e() {
			...
			w == k.getMonth() ? v.find(".day.this-month").removeClass("today").eq(b - 1).addClass("today") : v.find(".day.this-month").removeClass("today").attr("style", ""), v.find(".today").prevAll(".day").removeClass("this-month");v.find(".days").attr("data-month", w + 1).attr("data-year", E), v.find(".added-event").each(function(t) {
