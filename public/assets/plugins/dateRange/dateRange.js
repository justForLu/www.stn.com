...
*/
    ...
    var wrapper = {
		...
		ta:[
			'<div id="' + this.calendarId + '" class="ta_calendar ta_calendar2 cl">',
				
				'<div class="ta_calendar_footer cl" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
				    '<div class="frm_btn">',
					...
					'</div>',
					'<div class="frm_msg">',
						'<div class="cl" id="' + this.dateRangeDiv + '">',
...
//							'<span class="' + this.mOpts.joinLineId + '"> 共2晚 </span>',
						'</div>',
					...
					'</div>',
				'</div>',
				'<div class="ta_calendar_cont cl" id="'+ this.dateListId +'">',
...
pickerDateRange.prototype.show = function(isCompare, __method) {
	...
	$("#" + this.calendarId).css('top', pos.top + (__method.mOpts.theme=='ta'?0:22) + 'px');
	//第一次显示的时候，一定要初始化输入框
