		...
		init: function(fa) {
			return this.each(function() {
				...
				if (!e.data("isActive")) {
					...
					var M = function() {
						n.html('<span class="irs"><span class="irs-line"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min">0</span><span class="irs-max">1</span><span class="irs-from">0</span><span class="irs-to">0</span><span class="irs-single">0</span></span><span class="sz1">00:00</span><span class="sz2">02:13</span>');
						p = n.find(".irs");
						D = p.find(".irs-min");
						E = p.find(".irs-max");
						A = p.find(".irs-from");
						...
						a.hideFromTo || (A[0].style.visibility = "hidden", B[0].style.visibility = "visible", w[0].style.visibility = "hidden");
						a.hideMinMax && (D[0].style.visibility = "hidden", E[0].style.visibility = "hidden", R = Q = 0);
						a.hideMinMax || (D[0].style.visibility = "hidden", E[0].style.visibility = "hidden", a.values ? (D.html(a.prefix + a.values[0] + a.postfix), E.html(a.prefix + a.values[a.values.length - 1] + a.maxPostfix + a.postfix)) : (D.html(a.prefix + z(a.min) + a.postfix), E.html(a.prefix + z(a.max) + a.maxPostfix + a.postfix)), Q = D.outerWidth(!1), R = E.outerWidth(!1));
						ga()
					},
					ga = function() {
						if ("single" === a.type) {
